...
void initSlabTurbulence(ref_ptr<Grid3f> grid, double Brms, double lMin, double lMax,
	   double alpha = -11./3., int seed = 0, double lambda = 1);

void init2DTurbulence(ref_ptr<Grid3f> grid, double Brms, double lMin, double lMax,
	   double alpha = -11./3., int seed = 0, double lambda = 1);
